...
import QuantumTimeMachine from "./components/visualization/QuantumTimeMachine";
import TimeMachineWrapper from "./components/visualization/TimeMachineWrapper";
    ...
    <DndProvider backend={HTML5Backend}>
      <VStack spacing={0} align="stretch" h="100vh">
        ...
        <Flex flex={1} overflow="hidden">
          ...
          {/* Mobile: Render Sidebar for drawer functionality (hidden when desktop) */}
          {!isDesktop && <Sidebar />}
            ...
            <Flex direction="column" minH="100%">
              ...
              >
                ...
                {activePanel === "timemachine" && (
                  <TimeMachineWrapper qubits={qubits} gates={gates} />
                )}
        ...
        {/* Gate parameters panel - modal overlay */}
        <GateParamsPanel />
