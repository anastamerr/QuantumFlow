...
const TutorialPanel = () => {
  ...
  const currentStep = useSelector(selectTutorialStep)
  ...
  const onClose = () => {
    ...
    dispatch(setTutorialStep(0)) // reset to step 0 when closing (or keep as-is if you prefer)
  }
          ...
          <VStack spacing={6} align="stretch">
            ...
            <HStack spacing={8} justify="center" wrap="wrap">
              ...
              <VStack>
                ...
                <Text fontSize="sm" textAlign="center">
                  Instant quantum state evolution
                </Text>
              </VStack>
              <VStack>
      ...
      content: (
          <VStack spacing={6} align="stretch">
              ...
              <CardBody>
                <VStack spacing={4} align="stretch">
                  ...
                  <Text ml={8} color={codeColor}>
                    Click "Add Qubit" in the sidebar to create quantum bits for your circuit. Start with
                    2 qubits for most experiments.
                  </Text>
                  ...
                  <Text ml={8} color={codeColor}>
                    Drag quantum gates from the sidebar onto your circuit grid. Gates are applied
                    left-to-right in time sequence.
                  </Text>
                  ...
                  <Text ml={8} color={codeColor}>
                    Click on parameterized gates (like rotation gates) to adjust their angles and
                    properties.
                  </Text>
                  ...
                  <Text ml={8} color={codeColor}>
                    Switch to the Simulation panel and click "Run Simulation" to see your quantum
                    circuit in action!
                  </Text>
                </VStack>
              </CardBody>
            ...
            >
              ...
              <Text mt={2}>
                Try building a Bell State circuit: Start with 2 qubits, add a Hadamard (H) gate to
                qubit 0, then add a CNOT gate with qubit 0 as control and qubit 1 as target.
              </Text>
            </Box>
          </VStack>
      )
                    ...
                    <HStack spacing={4} wrap="wrap">
                      <Card minW="200px">
                        <CardBody>
                          ...
                          <Text fontSize="sm">
                            Creates superposition - puts qubit in equal combination of |0⟩ and |1⟩
                          </Text>
                        </CardBody>
                      </Card>
                      ...
                      <Card minW="200px">
                        <CardBody>
                          ...
                          <Text fontSize="sm">
                            Bit flip - transforms |0⟩ ↔ |1⟩ (quantum NOT gate)
                          </Text>
                        </CardBody>
                      </Card>
                    ...
                    <HStack spacing={4} wrap="wrap">
                      <Card minW="200px">
                        <CardBody>
                          ...
                          <Text fontSize="sm">
                            Flips target qubit only when control qubit is |1⟩. Creates entanglement.
                          </Text>
                        </CardBody>
                      </Card>
                      ...
                      <Card minW="200px">
                        <CardBody>
                          ...
                          <Text fontSize="sm">
                            Controlled-controlled-X gate. Flips target when both controls are |1⟩
                          </Text>
                        </CardBody>
                      </Card>
                    </HStack>
            ...
            <Card bg={useColorModeValue('green.50', 'green.900')}>
              <CardBody>
                ...
                <List spacing={1}>
                  <ListItem>
                    <Text fontSize="sm">
                      <Code>State Vector</Code> - Exact quantum simulation (default)
                    </Text>
                  </ListItem>
                  <ListItem>
                    <Text fontSize="sm">
                      <Code>Noisy Simulator</Code> - Includes realistic quantum noise
                    </Text>
                  </ListItem>
                  <ListItem>
                    <Text fontSize="sm">
                      <Code>Shots</Code> - Number of measurement repetitions (100-10,000)
                    </Text>
                  </ListItem>
                  <ListItem>
                    <Text fontSize="sm">
                      <Code>Real-time Viz</Code> - Live animation during simulation
                    </Text>
                  </ListItem>
                </List>
              </CardBody>
...
print("Results:", result.histogram(key='result'))`}</Code>
                    ...
                    <HStack spacing={4} wrap="wrap">
                      <Card minW="180px">
                        <CardBody>
                          ...
                          <Text fontSize="sm">
                            Complete circuit structure with all gate parameters and metadata
                          </Text>
                        </CardBody>
                      </Card>
                      ...
                      <Card minW="180px">
                        <CardBody>
                          ...
                          <Text fontSize="sm">
                            High-quality vector graphics for papers and presentations
                          </Text>
                        </CardBody>
                      </Card>
                    </HStack>
      ...
      content: (
          <VStack spacing={6} align="stretch">
                ...
                <CardBody>
                  <List spacing={2}>
                    <ListItem fontSize="sm">
                      Limit circuits to ~8 qubits for smooth performance
                    </ListItem>
                    <ListItem fontSize="sm">
                      Disable real-time visualization for large circuits
                    </ListItem>
                    <ListItem fontSize="sm">
                      Use "Jump to End" for faster simulation results
                    </ListItem>
              ...
              <Card maxW="300px">
                ...
                <CardBody>
                  <List spacing={2}>
                    ...
                    <ListItem fontSize="sm">
                      Export code to run on real quantum hardware
                    </ListItem>
                  </List>
                </CardBody>
              </Card>
              ...
              <CardBody>
                ...
                <HStack spacing={8} wrap="wrap">
                  <VStack align="start" spacing={1}>
                    <Text fontSize="sm">
                      <Code>Delete</Code> - Remove selected gate
                    </Text>
                    <Text fontSize="sm">
                      <Code>Esc</Code> - Close parameter panel
                    </Text>
                  </VStack>
                  <VStack align="start" spacing={1}>
                    <Text fontSize="sm">
                      <Code>Ctrl+Z</Code> - Undo (coming soon)
                    </Text>
                    <Text fontSize="sm">
                      <Code>Ctrl+C</Code> - Copy code to clipboard
                    </Text>
                  </VStack>
                </HStack>
              </CardBody>
            ...
            <Box textAlign="center" mt={6}>
              ...
              <Text mb={4}>
                You're now ready to build amazing quantum circuits with QuantumFlow. Start
                experimenting and discover the fascinating world of quantum computing!
              </Text>

              <Text mb={6}>
                Want to go deeper and run a full Quantum Key Distribution (QKD) simulation in Python
                (Qiskit)?
              </Text>
              <Button
                  as="a"
  ...
  return (
      ...
      >
        ...
        <ModalContent bg={bg} maxH="90vh" mx={isMobile ? 2 : 4}>
          <ModalHeader
              bg={headerBg}
              borderTopRadius="md"
              borderBottom="1px"
          ...
          <ModalBody p={6}>
            <Box minH="400px">{tutorialSteps[currentStep].content}</Box>
            ...
            <Flex justify="space-between" align="center">
              ...
              {currentStep === tutorialSteps.length - 1 ? (
                  <Button colorScheme="green" onClick={onClose} rightIcon={<CheckCircleIcon />}>
                    Get Started!
                  </Button>
              ) : (
                  <Button colorScheme="blue" onClick={nextStep} rightIcon={<ArrowForwardIcon />}>
                    Next
                  </Button>
              )}
            </Flex>
